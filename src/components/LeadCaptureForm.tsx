...
const LeadCaptureForm = () => {
  ...
  return (
    <section className="py-16 md:py-32 relative overflow-hidden bg-space-dark">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16 xl:px-24 relative z-10 max-w-[1600px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
          ...
          <motion.div
            ...
            className="bg-space-blue/20 backdrop-blur-md rounded-2xl border border-space-cyan/10 p-6 md:p-10 lg:p-12"
          >
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-5 md:space-y-7">
